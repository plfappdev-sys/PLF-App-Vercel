...
def main():
    ...
    parser.add_argument('--excel-file', type=str, help='Path to Excel file (default: NewBusLogic/Peoples Liberator Fund Contributions 2025 AppUPDATED.xlsx)')
    ...
    dry_run = args.dry_run or not args.do_import
    
    if dry_run and not args.do_import:
        print("⚠️  Running in DRY RUN mode (no database changes will be made)")
        print("   Use --import flag to actually import data")
