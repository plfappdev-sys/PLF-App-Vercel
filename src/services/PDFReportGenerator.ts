...
<body>
  ...
  // Generate HTML content for Interest Earned Report
  static generateInterestEarnedHTML(reportData: ReportData): string {
    const data = reportData.data;
...
<body>
    <div class="header">
        <h1>${reportData.title}</h1>
        <div class="subtitle">Interest Earned Analysis Report</div>
    </div>

    <div class="report-info">
        <p><strong>Period:</strong> ${new Date(data.period.startDate).toLocaleDateString('en-ZA')} to ${new Date(data.period.endDate).toLocaleDateString('en-ZA')}</p>
        <p><strong>Generated:</strong> ${reportData.generatedDate.toLocaleDateString('en-ZA')}</p>
        <p><strong>Generated By:</strong> ${reportData.generatedBy}</p>
    </div>
    ...
    <div class="metrics-grid">
        <div class="metric-card">
            <div class="metric-value">R ${data.totalInterestEarned.toLocaleString('en-ZA')}</div>
            <div class="metric-label">Total Interest Earned</div>
        </div>
        <div class="metric-card">
            <div class="metric-value">R ${data.totalInterestCharged.toLocaleString('en-ZA')}</div>
            <div class="metric-label">Total Interest Charged</div>
        </div>
        <div class="metric-card">
            <div class="metric-value">R ${data.netInterest.toLocaleString('en-ZA')}</div>
            <div class="metric-label">Net Interest</div>
        </div>
        <div class="metric-card">
            <div class="metric-value">${data.summary.totalMembers}</div>
            <div class="metric-label">Total Members</div>
        </div>
        <div class="metric-card">
            <div class="metric-value">${data.summary.membersWithSavings}</div>
            <div class="metric-label">Members with Savings</div>
        </div>
        <div class="metric-card">
            <div class="metric-value">${data.summary.averageInterestRate.toFixed(2)}%</div>
            <div class="metric-label">Average Interest Rate</div>
        </div>
    </div>

    <div class="section">
        <h2>Member Interest Breakdown</h2>
        <table class="member-table">
            ...
            <tbody>
                ${data.memberReports.slice(0, 50).map((report: any) => `
                    <tr>
                        <td>${report.memberNumber}</td>
                        <td class="amount positive">R ${report.actualInterestEarned.toLocaleString('en-ZA')}</td>
                        <td class="amount negative">R ${report.actualInterestCharged.toLocaleString('en-ZA')}</td>
                        <td class="amount ${(report.actualInterestEarned - report.actualInterestCharged) >= 0 ? 'positive' : 'negative'}">
                            R ${(report.actualInterestEarned - report.actualInterestCharged).toLocaleString('en-ZA')}
                        </td>
                    </tr>
                `).join('')}
            </tbody>
    ...
    <div class="footer">
        <p>This report contains interest data for ${data.memberReports.length} members.</p>
        <p>Generated by the People's Liberator Fund Management System.</p>
    </div>
</body>
</html>`;
  ...
  // Generate HTML content for Interest Charged Report
  static generateInterestChargedHTML(reportData: ReportData): string {
    const data = reportData.data;
...
<body>
    <div class="header">
        <h1>${reportData.title}</h1>
        <div class="subtitle">Interest Charged Analysis Report</div>
    </div>
    ...
    <div class="metrics-grid">
        ...
        <div class="metric-card">
            <div class="metric-value">${data.summary.membersWithLoans}</div>
            <div class="metric-label">Members with Loans</div>
        </div>
        <div class="metric-card">
            <div class="metric-value">${data.summary.averageLoanInterestRate.toFixed(2)}%</div>
            <div class="metric-label">Average Loan Interest Rate</div>
        </div>
    </div>

    <div class="section">
        <h2>Member Loan Interest Breakdown</h2>
        <table class="member-table">
            <thead>
                <tr>
                    <th>Member Number</th>
            ...
            <tbody>
                ${data.memberReports.slice(0, 50).map((report: any) => `
                    <tr>
                        <td>${report.memberNumber}</td>
                        <td class="amount negative">R ${report.actualInterestCharged.toLocaleString('en-ZA')}</td>
                        <td class="amount negative">R ${(report.actualInterestCharged * 10).toLocaleString('en-ZA')}</td>
                    </tr>
                `).join('')}
            </tbody>
        </table>
    ...
    <div class="footer">
        <p>This report contains interest data for ${data.memberReports.length} members with outstanding loans.</p>
        <p>Generated by the People's Liberator Fund Management System.</p>
    </div>
</body>
</html>`;
  ...
  // Generate HTML content for Member Interest Statement
  static generateMemberInterestStatementHTML(reportData: ReportData): string {
    const data = reportData.data;
...
<body>
    <div class="header">
        <h1>${reportData.title}</h1>
        <div class="subtitle">Personal Interest Statement</div>
    </div>

    <div class="member-info">
        <p><strong>Member:</strong> ${data.member.name}</p>
        <p><strong>Member Number:</strong> ${data.member.memberNumber}</p>
        <p><strong>Current Balance:</strong> R ${data.member.currentBalance.toLocaleString('en-ZA')}</p>
        <p><strong>Total Contributions:</strong> R ${data.member.totalContributions.toLocaleString('en-ZA')}</p>
        <p><strong>Period:</strong> ${new Date(data.period.startDate).toLocaleDateString('en-ZA')} to ${new Date(data.period.endDate).toLocaleDateString('en-ZA')}</p>
    </div>

    <div class="metrics-grid">
        <div class="metric-card">
            <div class="metric-value positive">R ${data.summary.totalInterestEarned.toLocaleString('en-ZA')}</div>
            <div class="metric-label">Interest Earned</div>
        </div>
        <div class="metric-card">
            <div class="metric-value negative">R ${data.summary.totalInterestCharged.toLocaleString('en-ZA')}</div>
            <div class="metric-label">Interest Charged</div>
        </div>
        <div class="metric-card">
            <div class="metric-value ${data.summary.netInterest >= 0 ? 'positive' : 'negative'}">
                R ${data.summary.netInterest.toLocaleString('en-ZA')}
            </div>
            <div class="metric-label">Net Interest</div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="interest-details">
            <table class="detail-table">
                <tr>
                    <td>Period Start:</td>
                    <td>${new Date(data.period.startDate).toLocaleDateString('en-ZA')}</td>
                </tr>
                <tr>
                    <td>Period End:</td>
                    <td>${new Date(data.period.endDate).toLocaleDateString('en-ZA')}</td>
                </tr>
                <tr>
                    <td>Period Days:</td>
                ...
                <tr>
                    <td>Interest Rate:</td>
                    <td>${data.interestDetails.interestRate.toFixed(2)}%</td>
                </tr>
                <tr>
                    <td>Calculation Method:</td>
                    <td>${data.interestDetails.calculationMethod}</td>
                </tr>
                <tr>
                    <td>Compounding:</td>
                    <td>${data.interestDetails.compounding ? 'Yes' : 'No'}</td>
                </tr>
                <tr>
                    <td>Tax Deduction:</td>
                    <td>${data.interestDetails.taxDeduction}%</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="footer">
        <p><strong>Important Notice:</strong> This interest statement reflects your account status as of ${reportData.generatedDate.toLocaleDateString('en-ZA')}.</p>
        <p>For any discrepancies or questions regarding this statement, please contact the fund administrators immediately.</p>
        <p>This is an official document of the People's Liberator Fund.</p>
        <p>Generated on ${reportData.generatedDate.toLocaleDateString('en-ZA')} at ${reportData.generatedDate.toLocaleTimeString('en-ZA')}</p>
    </div>
